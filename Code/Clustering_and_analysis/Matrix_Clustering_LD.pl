...
my $ThreeGold_MacOS_Matrix_Clustering = Matrix_Clustering_LD->new($ERROR_THRESHOLD, $TAG_OUTPUT_SEQ, $TAG_OUTPUT_ID, $SINGLETONS_IN, $AVE_DIST_IN, $CLUSTERS_IN, $SIZE_IN, $QUIET, $THREADS);
